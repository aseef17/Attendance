...
public class TuesdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        items.add(new TimeTableItem("OR", "Ashwini", "8:30 - 9:20"));
        items.add(new TimeTableItem("Python", "Vinutha", "9:20 - 10:10"));
        items.add(new TimeTableItem("Tea Break", "","10:10 - 10:30"));
        items.add(new TimeTableItem("OS", "Mahalakshmi","10:30 - 11:20"));
        items.add(new TimeTableItem("CNC", "Shwetha", "11:20 - 12:10"));
        items.add(new TimeTableItem("FS(Tutorial)", "Veena", "12:10 - 1:00"));
