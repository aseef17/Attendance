...
public class FridayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        items.add(new TimeTableItem("ST", "Manjunath", "8:30 - 9:20"));
        items.add(new TimeTableItem("OR", "Ashwini", "9:20 - 10:10"));
        items.add(new TimeTableItem("Tea Break", "","10:10 - 10:30"));
        items.add(new TimeTableItem("CNC", "Shwetha","10:30 - 11:20"));
        items.add(new TimeTableItem("FS", "Veena", "11:20 - 12:10"));
        items.add(new TimeTableItem("CNC(Tutorial)", "Shwetha", "12:10 - 1:00"));
        items.add(new TimeTableItem("Lunch Break", "", "1:00 - 2:00"));
        items.add(new TimeTableItem("Club Activity", "", "2:00 - 3:40"));
